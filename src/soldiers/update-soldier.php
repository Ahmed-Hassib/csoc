...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if (empty($err_arr)) {
    ...
    // update new soldier
    $is_updated = $soldier_obj->update_soldier(array($rank, $soldier_name, $soldier_addr, $phone_1, $phone_2, $militiry_num, $national_id, $basic_unit, $current_unit, $qualification, $specialization, $joined_date, $discharge_date, $status, $child, $father_job, $mother_job, $religion, $soldier_id));
