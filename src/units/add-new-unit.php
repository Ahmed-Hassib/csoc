...
<div class="container">
  ...
  <section class="units-content">
    <form class="add-new" action="">
      ...
      <!-- unit phone -->
      <div class="form-floating">
        <input type="text" class="form-control" id="unit-phone" name="unit-phone" placeholder="<?php echo lang("UNIT PHONE", "units") ?>" required>
      ...
      <!-- unit leader name -->
      <div class="form-floating">
        <input type="text" class="form-control" id="unit-leader" name="unit-leader" placeholder="<?php echo lang("UNIT LEADER NAME", "units") ?>" required>
        <label for="unit-leader"><?php echo lang("UNIT LEADER NAME", "units") ?></label>
      </div>
      <!-- unit leader phone -->
      <div class="form-floating">
